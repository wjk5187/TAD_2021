...
#scores and answers not organized the best
...
#it appears performance goes marginally down
...
###  "The default is uniform priors The default is uniform priors"
###  "which sets the unconditional probability of observing the one class to be the same as observing any other class."
### under uniform gives a 50-50 chnace of being either sports or crime headline 
...
### re-running w/ prior = "docfreq" entails the modle will not be balanced between CRIME and SPORT 
...
#priors w/ docfreq reflecting actuel proportions from data set
#priors: 0.4089264 0.5910736 
